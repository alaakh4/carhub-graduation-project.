...
define(['jquery', 'knockout', 'models/profile.model', 'models/orders.model', 'accUtils'], function ($, ko, profileModel, ordersModel, accUtils) {
  function ProfileViewModel() {
    ...
    self.avatarSrc = ko.pureComputed(function () {
      ...
      return 'http://localhost:4567/' + self.profile.avatar_url()
      else return 'http://localhost:4567/carhubfiles/uploads/clients/avatar.png'
    });
      ...
      ordersModel.listOrderHistory(function (ok, data, status) {
        ...
        list = list.map(function (order) {
          ...
          var previewImage = order.preview_image
            ? 'http://localhost:4567' + order.preview_image
